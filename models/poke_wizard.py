...
class PokeWizard(models.TransientModel):
    ...
    result_name = fields.Char(string='Nombre', readonly=True,force_save=True)
    result_id = fields.Integer(string='ID', readonly=True,force_save=True)

    # Datos de Pokémon
    height_cm = fields.Float(string='Altura (cm)', readonly=True,force_save=True)
    weight_kg = fields.Float(string='Peso (kg)', readonly=True,force_save=True)
    poke_types = fields.Char(string='Tipos', readonly=True,force_save=True)

    # Datos de Objetos
    item_cost = fields.Integer(string='Costo', readonly=True,force_save=True)
    item_effect = fields.Text(string='Efecto', readonly=True,force_save=True)

    # Imágenes
    sprite_front = fields.Binary(string='Vista Frontal', readonly=True,force_save=True)
    sprite_back = fields.Binary(string='Vista Trasera', readonly=True,force_save=True)
